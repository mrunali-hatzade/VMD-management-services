...
const servicesList = [
  { slug: 'security-guards', title: 'Security Guards', icon: <ShieldCheck size={40} />, desc: 'Police-verified, physically fit, and trained guards for 24/7 vigil.', img: '/v2/srv_security_guards_v2.jpg' },
  { slug: 'housekeeping-services', title: 'Housekeeping Services', icon: <Users size={40} />, desc: 'Meticulous corporate cleaning, sanitation, and hygiene upkeep.', img: '/v2/srv_housekeeping_v2.jpg' },
  { slug: 'office-boys', title: 'Office Boys', icon: <Briefcase size={40} />, desc: 'Polite pantry, filing, and errand staff for seamless office operations.', img: '/v2/srv_office_boys_v3.jpg' },
  { slug: 'supervisors', title: 'Supervisors', icon: <UserCheck size={40} />, desc: 'Experienced field supervisors ensuring 100% guard vigilance & audit.', img: '/v2/gal_vip_supervisors_v2.jpg' },
  { slug: 'facility-management', title: 'Facility Management', icon: <Building2 size={40} />, desc: 'End-to-end management of utilities, maintenance, and facility staff.', img: '/v2/srv_facility_mgmt_v4.png' },
  { slug: 'industrial-security', title: 'Industrial Security', icon: <Factory size={40} />, desc: 'Gate pass control, material audit, and perimeter protection for factories.', img: '/v2/gal_industrial_facility_v2.jpg' },
  { slug: 'residential-security', title: 'Residential Security', icon: <MapPin size={40} />, desc: 'Visitor management, parking order, and perimeter safety for societies.', img: '/v2/gal_residential_guard_v2.jpg' },
  { slug: 'corporate-security', title: 'Corporate Security', icon: <Building size={40} />, desc: 'Sophisticated reception security and IT park access management.', img: '/v2/gal_reception_security_v2.jpg' },
];
